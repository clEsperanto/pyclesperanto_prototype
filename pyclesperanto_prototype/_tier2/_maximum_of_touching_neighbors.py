...
@plugin_function
def maximum_of_touching_neighbors(src_values : Image, touch_matrix : Image, dst_values : Image):
    """
    ...
    execute(__file__, 'maximum_of_touching_neighbors_x.cl', 'maximum_value_of_touching_neighbors', dst_values.shape, parameters)
