...
@plugin_function
def mean_of_touching_neighbors(src_values : Image, touch_matrix : Image, dst_values : Image):
    """
    ...
    execute(__file__, 'mean_of_touching_neighbors_x.cl', 'mean_value_of_touching_neighbors', dst_values.shape, parameters)
