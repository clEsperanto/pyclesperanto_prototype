...
@plugin_function
def median_of_touching_neighbors(src_values : Image, touch_matrix : Image, dst_values : Image):
    """
    ...
    execute(__file__, 'median_of_touching_neighbors_x.cl', 'median_value_of_touching_neighbors', dst_values.shape, parameters)
