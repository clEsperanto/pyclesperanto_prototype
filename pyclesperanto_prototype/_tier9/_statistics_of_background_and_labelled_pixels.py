...
def statistics_of_background_and_labelled_pixels(input : Image = None, labelmap : Image = None, measure_shape : bool = True, extra_properties=[], use_gpu : bool = False):
    ...
    regionprops = statistics_of_labelled_pixels(input, temp, measure_shape=measure_shape, extra_properties=extra_properties, use_gpu=use_gpu)
