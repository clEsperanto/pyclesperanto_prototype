...
def read_intensities(pointlist : Image, intensity_image : Image, values_destination : Image = None):
    ...
    execute(__file__, 'read_intensities_x.cl', 'read_intensities', values_destination.shape, parameters)
