...
def test_statistics_of_labelled_pixels_gpu():
    intensity = cle.push_zyx(np.asarray([
        [0, 1, 2],
        [1, 2, 3],
        [2, 3, 4]
...
def test_statistics_of_labelled_pixels_3d_gpu():
    intensity = cle.push_zyx(np.asarray([
        [
            [0, 1, 2],
        ],[
...
def test_standard_deviation_gpu():
    import numpy as np
    ...
    stats = cle.statistics_of_labelled_pixels(image, labels, use_gpu=True)
